(function($) {
    ...
    var themes = [
        { name: 'bootstrap', url: '/theme/bootstrap/bootstrap.min.css' },
        { name: 'amelia', url: '/theme/amelia/bootstrap.min.css' },
        { name: 'cerulean', url: '/theme/cerulean/bootstrap.min.css' },
        { name: 'cosmo', url: '/theme/cosmo/bootstrap.min.css' },
        { name: 'cyborg', url: '/theme/cyborg/bootstrap.min.css' },
        { name: 'flatly', url: '/theme/flatly/bootstrap.min.css' },
        { name: 'journal', url: '/theme/journal/bootstrap.min.css' },
        { name: 'readable', url: '/theme/readable/bootstrap.min.css' },
        { name: 'simplex', url: '/theme/simplex/bootstrap.min.css' },
        { name: 'slate', url: '/theme/slate/bootstrap.min.css' },
        { name: 'spacelab', url: '/theme/spacelab/bootstrap.min.css' },
        { name: 'united', url: '/theme/united/bootstrap.min.css' },
        { name: 'yeti', url: '/theme/yeti/bootstrap.min.css' }
    ];
